    ...
    useEffect(() => {
      ...
      const slugData = async () => {
        try {
          ...
          const pageDescription = pageData._embedded?.["wp:featuredmedia"]?.[0]?.caption?.rendered;
          const cleanDescription = pageDescription ? pageDescription.replace(/<p>|<\/p>/g, '').trim() : 'No description available';
  ...
  return (
    <Fragment>
      ...
      <main className="content-wrapper bg-green1">
        <ProjectDetailBanner backgroundImage={state.backgroundImage} pageTitle={state.pageTitle} cleanDescription={state.cleanDescription}/>
